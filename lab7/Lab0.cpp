...
void Draw (void)
{
  ...
  glUniform3f(h_uDiffuse, 0, 0, 0);
  glUniform3f(h_uSpecular, 0, 0, 0);
  glUniform3f(h_uAmbient, 0, 0, 1);
  glUniform1f(h_uShininess, 200.0);
  ...
  */
  ...
  ModelTrans.rotate(g_rangle, vec3(0, 1, 0));
  SetModel();
  safe_glEnableVertexAttribArray(h_aPosition);
  // bind vbo
  glBindBuffer(GL_ARRAY_BUFFER, CubeBuffObj);
  ...
  glUniform3f(h_uDiffuse, 0.7, 0.2, 0.2);
  glUniform3f(h_uSpecular, 0.7, 0.98, 0.9);
  glUniform3f(h_uAmbient, 0.1, 0.1, 0.2);
  glUniform1f(h_uShininess, 100.0);
  ...
  glUniform3f(h_uDiffuse, 0.5, 0.3, 0.2);
  glUniform3f(h_uSpecular, 0.7, 0.98, 0.9);
  glUniform3f(h_uAmbient, 0.2, 0.0, 0.1);
  glUniform1f(h_uShininess, 200.0);
